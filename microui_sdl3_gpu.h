...
static const unsigned char mu_font_data[MU_FONT_NUM_CHARS][MU_FONT_GLYPH_BYTES] = {
  ...
  /* 33 '!' */ {0x00,0x00,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x18,0x18,0x00,0x00},
  /* 34 '"' */ {0x00,0x00,0x6c,0x6c,0x6c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /* 35 '#' */ {0x00,0x00,0x6c,0x6c,0xfe,0x6c,0x6c,0xfe,0x6c,0x6c,0x00,0x00,0x00},
  /* 36 '$' */ {0x00,0x18,0x3c,0x7e,0x5a,0x18,0x3c,0x7e,0x5a,0x18,0x18,0x00,0x00},
  /* 37 '%' */ {0x00,0x00,0x62,0x64,0x08,0x10,0x20,0x4c,0x8c,0x00,0x00,0x00,0x00},
  /* 38 '&' */ {0x00,0x00,0x38,0x6c,0x6c,0x38,0x76,0xdc,0xcc,0x76,0x00,0x00,0x00},
  /* 39 ''' */ {0x00,0x00,0x18,0x18,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /* 40 '(' */ {0x00,0x00,0x0c,0x18,0x30,0x30,0x30,0x30,0x30,0x18,0x0c,0x00,0x00},
  /* 41 ')' */ {0x00,0x00,0x30,0x18,0x0c,0x0c,0x0c,0x0c,0x0c,0x18,0x30,0x00,0x00},
  /* 42 '*' */ {0x00,0x00,0x00,0x66,0x3c,0xff,0x3c,0x66,0x00,0x00,0x00,0x00,0x00},
  /* 43 '+' */ {0x00,0x00,0x00,0x18,0x18,0x7e,0x18,0x18,0x00,0x00,0x00,0x00,0x00},
  /* 44 ',' */ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x30,0x00},
  /* 45 '-' */ {0x00,0x00,0x00,0x00,0x00,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /* 46 '.' */ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00},
  /* 47 '/' */ {0x00,0x00,0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x00,0x00,0x00,0x00},
  /* 48 '0' */ {0x00,0x00,0x3c,0x66,0x6e,0x7e,0x76,0x66,0x66,0x3c,0x00,0x00,0x00},
  /* 49 '1' */ {0x00,0x00,0x18,0x38,0x18,0x18,0x18,0x18,0x18,0x3c,0x00,0x00,0x00},
  /* 50 '2' */ {0x00,0x00,0x3c,0x66,0x06,0x0c,0x18,0x30,0x60,0x7e,0x00,0x00,0x00},
  /* 51 '3' */ {0x00,0x00,0x3c,0x66,0x06,0x1c,0x06,0x06,0x66,0x3c,0x00,0x00,0x00},
  /* 52 '4' */ {0x00,0x00,0x0c,0x1c,0x3c,0x6c,0xcc,0xfe,0x0c,0x0c,0x00,0x00,0x00},
  /* 53 '5' */ {0x00,0x00,0x7e,0x60,0x60,0x7c,0x06,0x06,0x66,0x3c,0x00,0x00,0x00},
  /* 54 '6' */ {0x00,0x00,0x1c,0x30,0x60,0x7c,0x66,0x66,0x66,0x3c,0x00,0x00,0x00},
  /* 55 '7' */ {0x00,0x00,0x7e,0x06,0x0c,0x18,0x30,0x30,0x30,0x30,0x00,0x00,0x00},
  /* 56 '8' */ {0x00,0x00,0x3c,0x66,0x66,0x3c,0x66,0x66,0x66,0x3c,0x00,0x00,0x00},
  /* 57 '9' */ {0x00,0x00,0x3c,0x66,0x66,0x66,0x3e,0x06,0x0c,0x38,0x00,0x00,0x00},
  /* 58 ':' */ {0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00},
  /* 59 ';' */ {0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x18,0x18,0x30,0x00,0x00},
  /* 60 '<' */ {0x00,0x00,0x06,0x0c,0x18,0x30,0x60,0x30,0x18,0x0c,0x06,0x00,0x00},
  /* 61 '=' */ {0x00,0x00,0x00,0x00,0x7e,0x00,0x00,0x7e,0x00,0x00,0x00,0x00,0x00},
  /* 62 '>' */ {0x00,0x00,0x60,0x30,0x18,0x0c,0x06,0x0c,0x18,0x30,0x60,0x00,0x00},
  /* 63 '?' */ {0x00,0x00,0x3c,0x66,0x06,0x0c,0x18,0x18,0x00,0x18,0x18,0x00,0x00},
  /* 64 '@' */ {0x00,0x00,0x3c,0x66,0x6e,0x7a,0x72,0x66,0x60,0x3c,0x00,0x00,0x00},
  /* 65 'A' */ {0x00,0x00,0x18,0x3c,0x66,0x66,0x7e,0x66,0x66,0x66,0x00,0x00,0x00},
  /* 66 'B' */ {0x00,0x00,0x7c,0x66,0x66,0x7c,0x66,0x66,0x66,0x7c,0x00,0x00,0x00},
  /* 67 'C' */ {0x00,0x00,0x3c,0x66,0x60,0x60,0x60,0x60,0x66,0x3c,0x00,0x00,0x00},
  /* 68 'D' */ {0x00,0x00,0x78,0x6c,0x66,0x66,0x66,0x66,0x6c,0x78,0x00,0x00,0x00},
  /* 69 'E' */ {0x00,0x00,0x7e,0x60,0x60,0x7c,0x60,0x60,0x60,0x7e,0x00,0x00,0x00},
  /* 70 'F' */ {0x00,0x00,0x7e,0x60,0x60,0x7c,0x60,0x60,0x60,0x60,0x00,0x00,0x00},
  /* 71 'G' */ {0x00,0x00,0x3c,0x66,0x60,0x60,0x6e,0x66,0x66,0x3e,0x00,0x00,0x00},
  /* 72 'H' */ {0x00,0x00,0x66,0x66,0x66,0x7e,0x66,0x66,0x66,0x66,0x00,0x00,0x00},
  /* 73 'I' */ {0x00,0x00,0x3c,0x18,0x18,0x18,0x18,0x18,0x18,0x3c,0x00,0x00,0x00},
  /* 74 'J' */ {0x00,0x00,0x1e,0x0c,0x0c,0x0c,0x0c,0x0c,0x6c,0x38,0x00,0x00,0x00},
  /* 75 'K' */ {0x00,0x00,0x66,0x6c,0x78,0x70,0x78,0x6c,0x66,0x66,0x00,0x00,0x00},
  /* 76 'L' */ {0x00,0x00,0x60,0x60,0x60,0x60,0x60,0x60,0x60,0x7e,0x00,0x00,0x00},
  /* 77 'M' */ {0x00,0x00,0x66,0x66,0x76,0x7e,0x6e,0x66,0x66,0x66,0x00,0x00,0x00},
  /* 78 'N' */ {0x00,0x00,0x66,0x66,0x76,0x7e,0x6e,0x66,0x66,0x66,0x00,0x00,0x00},
  /* 79 'O' */ {0x00,0x00,0x3c,0x66,0x66,0x66,0x66,0x66,0x66,0x3c,0x00,0x00,0x00},
  /* 80 'P' */ {0x00,0x00,0x7c,0x66,0x66,0x66,0x7c,0x60,0x60,0x60,0x00,0x00,0x00},
  /* 81 'Q' */ {0x00,0x00,0x3c,0x66,0x66,0x66,0x66,0x6e,0x3c,0x07,0x00,0x00,0x00},
  /* 82 'R' */ {0x00,0x00,0x7c,0x66,0x66,0x7c,0x78,0x6c,0x66,0x66,0x00,0x00,0x00},
  /* 83 'S' */ {0x00,0x00,0x3c,0x66,0x60,0x3c,0x06,0x06,0x66,0x3c,0x00,0x00,0x00},
  /* 84 'T' */ {0x00,0x00,0x7e,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x00},
  /* 85 'U' */ {0x00,0x00,0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x3c,0x00,0x00,0x00},
  /* 86 'V' */ {0x00,0x00,0x66,0x66,0x66,0x66,0x66,0x3c,0x3c,0x18,0x00,0x00,0x00},
  /* 87 'W' */ {0x00,0x00,0x66,0x66,0x66,0x6e,0x7e,0x76,0x66,0x66,0x00,0x00,0x00},
  /* 88 'X' */ {0x00,0x00,0x66,0x66,0x3c,0x18,0x3c,0x66,0x66,0x66,0x00,0x00,0x00},
  /* 89 'Y' */ {0x00,0x00,0x66,0x66,0x66,0x3c,0x18,0x18,0x18,0x18,0x00,0x00,0x00},
  /* 90 'Z' */ {0x00,0x00,0x7e,0x06,0x0c,0x18,0x30,0x60,0x60,0x7e,0x00,0x00,0x00},
  /* 91 '[' */ {0x00,0x00,0x3c,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x3c,0x00,0x00},
  /* 92 '\' */ {0x00,0x00,0x80,0x40,0x20,0x10,0x08,0x04,0x02,0x00,0x00,0x00,0x00},
  /* 93 ']' */ {0x00,0x00,0x3c,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x3c,0x00,0x00},
  /* 94 '^' */ {0x00,0x00,0x18,0x3c,0x66,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /* 95 '_' */ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0x00},
  /* 96 '`' */ {0x00,0x00,0x18,0x18,0x0c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
  /* 97 'a' */ {0x00,0x00,0x00,0x00,0x3c,0x06,0x3e,0x66,0x66,0x3e,0x00,0x00,0x00},
  /* 98 'b' */ {0x00,0x00,0x60,0x60,0x7c,0x66,0x66,0x66,0x66,0x7c,0x00,0x00,0x00},
  /* 99 'c' */ {0x00,0x00,0x00,0x00,0x3c,0x66,0x60,0x60,0x66,0x3c,0x00,0x00,0x00},
  /* 100 'd' */ {0x00,0x00,0x06,0x06,0x3e,0x66,0x66,0x66,0x66,0x3e,0x00,0x00,0x00},
  /* 101 'e' */ {0x00,0x00,0x00,0x00,0x3c,0x66,0x7e,0x60,0x66,0x3c,0x00,0x00,0x00},
  /* 102 'f' */ {0x00,0x00,0x1c,0x36,0x30,0x78,0x30,0x30,0x30,0x30,0x00,0x00,0x00},
  /* 103 'g' */ {0x00,0x00,0x00,0x00,0x3e,0x66,0x66,0x66,0x66,0x3e,0x06,0x66,0x3c},
  /* 104 'h' */ {0x00,0x00,0x60,0x60,0x7c,0x66,0x66,0x66,0x66,0x66,0x00,0x00,0x00},
  /* 105 'i' */ {0x00,0x00,0x18,0x00,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x00},
  /* 106 'j' */ {0x00,0x00,0x0c,0x00,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x6c,0x38},
  /* 107 'k' */ {0x00,0x00,0x60,0x60,0x66,0x6c,0x78,0x78,0x6c,0x66,0x00,0x00,0x00},
  /* 108 'l' */ {0x00,0x00,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x1c,0x00,0x00,0x00},
  /* 109 'm' */ {0x00,0x00,0x00,0x00,0x7c,0x6e,0x6e,0x6e,0x6e,0x6e,0x00,0x00,0x00},
  /* 110 'n' */ {0x00,0x00,0x00,0x00,0x7c,0x66,0x66,0x66,0x66,0x66,0x00,0x00,0x00},
  /* 111 'o' */ {0x00,0x00,0x00,0x00,0x3c,0x66,0x66,0x66,0x66,0x3c,0x00,0x00,0x00},
  /* 112 'p' */ {0x00,0x00,0x00,0x00,0x7c,0x66,0x66,0x66,0x66,0x7c,0x60,0x60,0x60},
  /* 113 'q' */ {0x00,0x00,0x00,0x00,0x3e,0x66,0x66,0x66,0x66,0x3e,0x06,0x06,0x06},
  /* 114 'r' */ {0x00,0x00,0x00,0x00,0x7c,0x66,0x60,0x60,0x60,0x60,0x00,0x00,0x00},
  /* 115 's' */ {0x00,0x00,0x00,0x00,0x3e,0x60,0x3c,0x06,0x06,0x7c,0x00,0x00,0x00},
  /* 116 't' */ {0x00,0x00,0x30,0x30,0x7c,0x30,0x30,0x30,0x30,0x1c,0x00,0x00,0x00},
  /* 117 'u' */ {0x00,0x00,0x00,0x00,0x66,0x66,0x66,0x66,0x66,0x3e,0x00,0x00,0x00},
  /* 118 'v' */ {0x00,0x00,0x00,0x00,0x66,0x66,0x66,0x66,0x3c,0x18,0x00,0x00,0x00},
  /* 119 'w' */ {0x00,0x00,0x00,0x00,0x66,0x6e,0x6e,0x7e,0x3c,0x18,0x00,0x00,0x00},
  /* 120 'x' */ {0x00,0x00,0x00,0x00,0x66,0x66,0x3c,0x3c,0x66,0x66,0x00,0x00,0x00},
  /* 121 'y' */ {0x00,0x00,0x00,0x00,0x66,0x66,0x66,0x66,0x66,0x3e,0x06,0x66,0x3c},
  /* 122 'z' */ {0x00,0x00,0x00,0x00,0x7e,0x0c,0x18,0x30,0x60,0x7e,0x00,0x00,0x00},
  /* 123 '{' */ {0x00,0x00,0x0e,0x18,0x18,0x18,0x70,0x18,0x18,0x18,0x0e,0x00,0x00},
  /* 124 '|' */ {0x00,0x00,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x00},
  /* 125 '}' */ {0x00,0x00,0x70,0x18,0x18,0x18,0x0e,0x18,0x18,0x18,0x70,0x00,0x00},
  /* 126 '~' */ {0x00,0x00,0x72,0x9c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
};
...
static void mu_push_quad(float x1, float y1, float x2, float y2,
                         ...
                         Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
    ...
    v[0].position[0] = x1; v[0].position[1] = y1; v[0].uv[0] = u1; v[0].uv[1] = v1;
    v[0].color[0] = r;   v[0].color[1] = g;   v[0].color[2] = b;   v[0].color[3] = a;

    v[1].position[0] = x2; v[1].position[1] = y1; v[1].uv[0] = u2; v[1].uv[1] = v1;
    v[1].color[0] = r;   v[1].color[1] = g;   v[1].color[2] = b;   v[1].color[3] = a;

    v[2].position[0] = x2; v[2].position[1] = y2; v[2].uv[0] = u2; v[2].uv[1] = v2;
    v[2].color[0] = r;   v[2].color[1] = g;   v[2].color[2] = b;   v[2].color[3] = a;

    v[3].position[0] = x1; v[3].position[1] = y2; v[3].uv[0] = u1; v[3].uv[1] = v2;
...
static void mu_upload_textures(SDL_GPUCommandBuffer *cmd) {
    ...
    for (int ci = 0; ci < MU_FONT_NUM_CHARS; ci++) {
        ...
        for (int row = 0; row < MU_FONT_GLYPH_H; row++) {
            ...
            for (int col = 0; col < MU_FONT_GLYPH_W; col++) {
                ...
                p[0] = 255; p[1] = 255; p[2] = 255; p[3] = on ? 255 : 0;
            }
        }
    }
    ...
    SDL_zero(src); src.transfer_buffer = tbuf; src.offset = 0;
    src.pixels_per_row = MU_FONT_TEX_W; src.rows_per_layer = MU_FONT_TEX_H;
    SDL_zero(dst); dst.texture = mu_gpu.font_texture;
    dst.w = MU_FONT_TEX_W; dst.h = MU_FONT_TEX_H; dst.d = 1;
    SDL_UploadToGPUTexture(cp, &src, &dst, false);

    SDL_zero(src); src.transfer_buffer = tbuf; src.offset = font_size;
    src.pixels_per_row = MU_ICON_TEX_W; src.rows_per_layer = MU_ICON_TEX_H;
    SDL_zero(dst); dst.texture = mu_gpu.icon_texture;
    dst.w = MU_ICON_TEX_W; dst.h = MU_ICON_TEX_H; dst.d = 1;
    SDL_UploadToGPUTexture(cp, &src, &dst, false);

    SDL_zero(src); src.transfer_buffer = tbuf; src.offset = font_size + icon_size;
    SDL_zero(dst); dst.texture = mu_gpu.white_texture;
...
void mu_sdl3_gpu_init(SDL_GPUDevice *device, SDL_Window *window,
                      mu_Context *ctx)
{
    SDL_zero(mu_gpu);
...
void mu_sdl3_gpu_handle_event(SDL_Event *evt, mu_Context *ctx) {
    ...
    case SDL_EVENT_MOUSE_BUTTON_DOWN: {
        int btn = 0;
        if (evt->button.button == SDL_BUTTON_LEFT)   btn = MU_MOUSE_LEFT;
        if (evt->button.button == SDL_BUTTON_RIGHT)  btn = MU_MOUSE_RIGHT;
        if (evt->button.button == SDL_BUTTON_MIDDLE) btn = MU_MOUSE_MIDDLE;
...
void mu_sdl3_gpu_upload(SDL_GPUCommandBuffer *cmd_buf, mu_Context *ctx) {
    ...
    while (mu_next_command(ctx, &cmd)) {
        ...
        case MU_COMMAND_ICON: {
            ...
            mu_push_quad(
                (float)(r.x + xoff), (float)(r.y + yoff),
                (float)(r.x + xoff + MU_ICON_SIZE), (float)(r.y + yoff + MU_ICON_SIZE),
                u1, v1, u2, v2,
                c.r, c.g, c.b, c.a
            );
            break;
    ...
    if (mu_gpu.vertex_buffer_capacity < vbytes) {
        if (mu_gpu.vertex_buffer) SDL_ReleaseGPUBuffer(mu_gpu.device, mu_gpu.vertex_buffer);
    ...
    if (mu_gpu.index_buffer_capacity < ibytes) {
        if (mu_gpu.index_buffer) SDL_ReleaseGPUBuffer(mu_gpu.device, mu_gpu.index_buffer);
        SDL_GPUBufferCreateInfo bi;
        SDL_zero(bi);
...
void mu_sdl3_gpu_render(SDL_GPUCommandBuffer *cmd_buf,
                        SDL_GPURenderPass *render_pass)
{
    if (!mu_gpu.pipeline || mu_gpu.vertex_count == 0) { return; }
...
void mu_sdl3_gpu_shutdown(void) {
    if (mu_gpu.vertex_buffer)  { SDL_ReleaseGPUBuffer(mu_gpu.device, mu_gpu.vertex_buffer);  mu_gpu.vertex_buffer = NULL; }
    if (mu_gpu.index_buffer)   { SDL_ReleaseGPUBuffer(mu_gpu.device, mu_gpu.index_buffer);   mu_gpu.index_buffer = NULL;  }
    if (mu_gpu.font_texture)   { SDL_ReleaseGPUTexture(mu_gpu.device, mu_gpu.font_texture);  mu_gpu.font_texture = NULL;  }
    if (mu_gpu.icon_texture)   { SDL_ReleaseGPUTexture(mu_gpu.device, mu_gpu.icon_texture);  mu_gpu.icon_texture = NULL;  }
    if (mu_gpu.white_texture)  { SDL_ReleaseGPUTexture(mu_gpu.device, mu_gpu.white_texture); mu_gpu.white_texture = NULL; }
    if (mu_gpu.sampler)        { SDL_ReleaseGPUSampler(mu_gpu.device, mu_gpu.sampler);       mu_gpu.sampler = NULL;       }
    if (mu_gpu.pipeline)       { SDL_ReleaseGPUGraphicsPipeline(mu_gpu.device, mu_gpu.pipeline); mu_gpu.pipeline = NULL; }
    if (mu_gpu.vertex_shader)  { SDL_ReleaseGPUShader(mu_gpu.device, mu_gpu.vertex_shader);  mu_gpu.vertex_shader = NULL; }
    if (mu_gpu.fragment_shader){ SDL_ReleaseGPUShader(mu_gpu.device, mu_gpu.fragment_shader); mu_gpu.fragment_shader = NULL; }

    if (mu_gpu.vertex_data)    { SDL_free(mu_gpu.vertex_data);  mu_gpu.vertex_data = NULL;  mu_gpu.vertex_data_cap = 0; }
    if (mu_gpu.index_data)     { SDL_free(mu_gpu.index_data);   mu_gpu.index_data = NULL;   mu_gpu.index_data_cap = 0;  }
